...
function(make_lib_simd_runtime name)
    ...
    set_target_properties(${name}_sse_or_arm
        PROPERTIES
    ...
    target_compile_definitions(${name}_sse_or_arm
        PRIVATE
    ...
    set_target_properties(${name}_avx
        PROPERTIES
            POSITION_INDEPENDENT_CODE TRUE
            VISIBILITY_INLINES_HIDDEN TRUE
            C_VISIBILITY_PRESET hidden
    ...
    target_compile_definitions(${name}_avx
        PRIVATE
            COMPILING_WITH_AVX=1
            $<IF:$<CONFIG:DEBUG>,DEBUG=1 _DEBUG=1,NDEBUG=1 _NDEBUG=1>
    )
    ...
    if(WIN32)
        ...
        if(COMPILER_OPT_ARCH_AVX_SUPPORTED)
            ...
            target_compile_options(${name}_avx PRIVATE /arch:AVX2)
        else()
